...
if __name__ == '__main__':
    ...
    if phenotype == "ogt":
        ...
        X_train, X_train_column_names, y_train, d_gtdb_train = process_dataset(Parameters.data_filename_train, Parameters.y_filename)
        print(f"Processing test dataset at {Parameters.data_filename_test}...")
        X_test, X_test_column_names, y_test, d_gtdb_test = process_dataset(Parameters.data_filename_test, Parameters.y_filename)
        num_classes = 2
